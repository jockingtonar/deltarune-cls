    ...
    },
    {
      ...
      objects = {
        ...
        },
        {
          ...
          properties = {
            ["solid"] = true,
            ["text1"] = "* There's nothing useful in the drawer.",
            ["text2"] = "* That is, unless a custom mixtape labelled \"4 dess\" is deemed useful.",
            ["text3"] = "* The dust tells you it never left the drawer."
          }
        },
        {
          id = 10,
          ...
          properties = {
            ...
            ["text2"] = "* (It hasn't looked like this in a while.)"
          }
        },
        {
          id = 11,
