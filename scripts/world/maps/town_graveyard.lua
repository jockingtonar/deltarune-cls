return {
  ...
  layers = {
    ...
    {
      type = "imagelayer",
      image = "../../../libraries/hometown_library-main/assets/sprites/world/maps/hometown/graveg.png",
      id = 13,
      name = "gate",
      class = "",
      visible = true,
    ...
    {
      type = "imagelayer",
      image = "../../../libraries/hometown_library-main/assets/sprites/world/maps/hometown/graves.png",
      id = 17,
      name = "graves",
      class = "",
      visible = true,
      ...
      objects = {
        ...
        },
        {
          ...
          properties = {
            ...
            ["text2"] = "* (He also kicked serious ass.)"
          }
        },
        {
          id = 15,
    ...
    {
      type = "imagelayer",
      image = "../../../libraries/hometown_library-main/assets/sprites/world/maps/hometown/gravegup.png",
      id = 12,
      name = "gateup",
      class = "",
      visible = true,
    ...
    {
      type = "imagelayer",
      image = "../../../libraries/hometown_library-main/assets/sprites/world/maps/hometown/graveyardover.png",
      id = 16,
      name = "overlay",
      class = "",
      visible = true,
