local character, super = Class(PartyMember, "jockington")
...
function character:init()
    ...
    self:setActor("jockington")
    self:setLightActor("jockington_lw")
    ...
    self.menu_icon = "party/jockington/head"
    -- Path to head icons used in battle
    self.head_icons = "party/jockington/icon"
    -- Name sprite (optional)
    self.name_sprite = "party/jockington/name"
